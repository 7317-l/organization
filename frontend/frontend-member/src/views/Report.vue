    ...
    <div v-loading="loading">
      ...
      <template v-else>
        ...
        <div class="report-ai">
          ...
          <div class="report-ai-text">{{ reportData.summary || reportData.comment || reportData.assessment || reportData.aiComment || '暂无评语' }}</div>
        </div>
...
const dimensions = computed(() => {
  ...
  const defaultDims = [
    { key: 'duration', name: '学习时长', value: 0 },
    { key: 'content', name: '内容完成', value: 0 },
    { key: 'task', name: '任务完成', value: 0 },
    { key: 'exam', name: '测验成绩', value: 0 },
    { key: 'error', name: '错题掌握', value: 0 }
  ]
